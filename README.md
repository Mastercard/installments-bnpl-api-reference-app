...
JWE Config for POST Merchant Particpations
...
5. Open ```src/main/resources/application.yml``` and configure:
    - ```mastercard.api.environment.base-path ```- Refers to sandbox endpoint, its a static field, will be used as a host to make API calls.
